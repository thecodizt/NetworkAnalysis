...
def clusterrank_centrality(adj_matrix):
    """
    ...
    clusterrank_centrality = ncl.cluster_rank_centrality(G)

    return clusterrank_centrality
...
if __name__ == "__main__":
    ...
    eigenvector = clusterrank_centrality(adjacency_matrix)
